        ...
        return this.each(function() {
            ...
            if (b.thumb) {
                ...
                C.children(":eq(0)").children().each(function(L) {
                    ...
                    var K = '<li><div class="imgWrap"><img src="' + N + '" id="imgshow" alt="' + I + '" /></div><div class="opacity"></div>' + I + '<div class="text">' + M + "</div></li>";
                    a(this).data("data", L);
                    q.append(K)
                });
...
function showimg(str){
    document.getElementById("imgshow").src=str;
     $(".thumbCont ul li img").addClass('addFilter');

}
 $(function(){  
                $(".thumbCont ul li img").on({  
                    mouseover : function(){  
                        $(this).removeClass('addFilter') ;  
                    } ,  
                    mouseout : function(){  
